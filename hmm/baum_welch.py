...
from hmm import forward_probability as forward
from hmm import backward_probability as backward
# 单个状态的概率
from hmm import single_state_probability_of_gamma as single
# 联合状态的概率
from hmm import continuous_state_probability_of_ksi as continuous
import numpy as np
